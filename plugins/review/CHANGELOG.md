...
### Fixes
- correct backwards half-write claim + mislabeled deferred entries
- apply valid personas in a batch even when others are deferred
...
### Fixes
- accept heading-form and "Does NOT cover" persona sections in the validator

## 1.3.0

### Features
- Add review_cli scaffold for new archetype personas
