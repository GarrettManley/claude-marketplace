...
description: |
  Use when reviewing design documents, PRs, or operational docs that define trust boundaries, access controls, or authentication flows. Focuses on attack surface, least-privilege violations, and defense-in-depth gaps.
