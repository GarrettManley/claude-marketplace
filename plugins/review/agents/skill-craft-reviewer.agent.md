---
name: skill-craft-reviewer
description: |
  Use when reviewing skill files for Claude Code plugins. Focuses on triggering accuracy, progressive disclosure, Iron Law compliance, and description quality.
