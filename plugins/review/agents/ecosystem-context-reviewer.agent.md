---
name: ecosystem-context-reviewer
description: |
  Use when reviewing designs, PRs, or features that touch external integrations, decision log entries, or partner-facing interfaces. Catches missing integration acknowledgments and ADR conflicts.
