...
| learning | `instinct-detect` | Claude-driven detection of correction and preference instincts from the transcript + observations (Phase 2c) |
| learning | `instinct-export` | Export instincts to a YAML file (global or project scope) |
| learning | `instinct-from-retro` | Mine retrospectives' recurring friction Rules into retro-mined instincts (Phase 2d) |
| learning | `instinct-import` | Import instincts from a YAML file into global or project scope |
| learning | `instinct-status` | Show learned instincts (project + global) with confidence |
